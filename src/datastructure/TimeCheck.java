...
public class TimeCheck {
    ...
    public static void main(String args[]) {
        ...
        // System.out.println(makeStnTime(new String[]{"DT10", "DT11"}, timeMap,
        // LocalTime.of(4, 30)));
        // System.out.println(makeStnTime(new String[]{"DT10", "DT9"}, timeMap,
        // LocalTime.of(22, 30)));
    }
    ...
    /**
     * Checks whether the user can make it in time to the destination based on the
     * shortest path possible and their last train timings.
     * 
     * @param arr     The shortest path generated by the app.
     * @param timeMap The map of MRT stations with their last train timings.
     * @param now     The time now.
     * @return True if the user can make it in time. Otherwise, return false.
     */
    public static boolean makeStnTime(ArrayList<String> arr,
